...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_USERMUTABLE']._serialized_start = 227
    _globals['_USERMUTABLE']._serialized_end = 276
    _globals['_CREATEUSERREQUEST']._serialized_start = 278
    _globals['_CREATEUSERREQUEST']._serialized_end = 340
    _globals['_GETUSERBYIDREQUEST']._serialized_start = 342
    _globals['_GETUSERBYIDREQUEST']._serialized_end = 374
    _globals['_GETUSERBYNAMEREQUEST']._serialized_start = 376
    _globals['_GETUSERBYNAMEREQUEST']._serialized_end = 416
    _globals['_UPDATEUSERBYIDREQUEST']._serialized_start = 418
    _globals['_UPDATEUSERBYIDREQUEST']._serialized_end = 496
    _globals['_UPDATEUSERBYNAMEREQUEST']._serialized_start = 498
    _globals['_UPDATEUSERBYNAMEREQUEST']._serialized_end = 584
    _globals['_DELETEUSERBYIDREQUEST']._serialized_start = 586
    _globals['_DELETEUSERBYIDREQUEST']._serialized_end = 621
    _globals['_DELETEUSERBYNAMEREQUEST']._serialized_start = 623
    _globals['_DELETEUSERBYNAMEREQUEST']._serialized_end = 666
    _globals['_USEREVENT']._serialized_start = 668
    _globals['_USEREVENT']._serialized_end = 729
    _globals['_USERSERVICE']._serialized_start = 732
    _globals['_USERSERVICE']._serialized_end = 1296