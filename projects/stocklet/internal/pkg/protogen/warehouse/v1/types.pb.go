...
func (x *WarehouseStock) GetProductId() string {
	if x != nil {
		return x.ProductId
	}
	return ""
...
type WarehouseStockReservation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WarehouseStockReservation) Reset() {
	*x = WarehouseStockReservation{}
	if protoimpl.UnsafeEnabled {
...
func (x *WarehouseStockReservation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WarehouseStockReservation) ProtoMessage() {}

func (x *WarehouseStockReservation) ProtoReflect() protoreflect.Message {
	mi := &file_stocklet_warehouse_v1_types_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WarehouseStockReservation.ProtoReflect.Descriptor instead.
func (*WarehouseStockReservation) Descriptor() ([]byte, []int) {
	return file_stocklet_warehouse_v1_types_proto_rawDescGZIP(), []int{1}
}

func (x *WarehouseStockReservation) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *WarehouseStockReservation) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
func (x *WarehouseStockReservation) GetProductId() string {
	if x != nil {
		return x.ProductId
	}
	return ""
...
func (x *WarehouseStockReservation) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
var file_stocklet_warehouse_v1_types_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5d, 0x0a, 0x0e, 0x57, 0x61, 0x72, 0x65, 0x68,
	0x6f, 0x75, 0x73, 0x65, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x12, 0x26, 0x0a, 0x0a, 0x70, 0x72, 0x6f,
	...
	0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0xa5, 0x01, 0x0a, 0x19, 0x57, 0x61, 0x72, 0x65, 0x68,
	0x6f, 0x75, 0x73, 0x65, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61,
	...
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x42, 0x07, 0xba, 0x48, 0x04,
	0x1a, 0x02, 0x20, 0x00, 0x52, 0x08, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x42, 0x4d,
	0x5a, 0x4b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x65, 0x78,
	...
	0x67, 0x65, 0x6e, 0x2f, 0x77, 0x61, 0x72, 0x65, 0x68, 0x6f, 0x75, 0x73, 0x65, 0x2f, 0x76, 0x31,
...
var file_stocklet_warehouse_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_stocklet_warehouse_v1_types_proto_goTypes = []interface{}{
	(*WarehouseStock)(nil),            // 0: stocklet.warehouse.v1.WarehouseStock
	(*WarehouseStockReservation)(nil), // 1: stocklet.warehouse.v1.WarehouseStockReservation
}
...
func file_stocklet_warehouse_v1_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_stocklet_warehouse_v1_types_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WarehouseStockReservation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
